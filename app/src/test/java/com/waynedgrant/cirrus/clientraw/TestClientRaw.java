...
public class TestClientRaw
{
    ...
    {
        InputStream is = createClientRawWithFields(new ClientRawStringGenerator.Field(ClientRaw.APPARENT_TEMPERATURE_CELSIUS, "10.7"));
        testee = ClientRaw.getInstance(is);
    ...
    {
        InputStream is = createClientRawWithFields(new ClientRawStringGenerator.Field(ClientRaw.APPARENT_TEMPERATURE_CELSIUS, "-"));
        testee = ClientRaw.getInstance(is);
    ...
    {
        testee = ClientRaw.getInstance(createClientRawOfSize(ClientRaw.APPARENT_TEMPERATURE_CELSIUS));
        assertNull(testee.getApparentTemperature());
    }
